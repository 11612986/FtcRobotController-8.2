...
public class Autonomous_Working extends LinearOpMode{
    ...
    public void goTowardsTag(int tag){
        if(tag == left){
            ...
            dropPixel();
            sleep(3000);
            encoderDrive(DRIVE_SPEED,0.2,-0.2,3);
            ...
            encoderDrive(DRIVE_SPEED,-1.45,1.45,3);

            encoderDrive(DRIVE_SPEED, -23, -23, 20);
            ...
            encoderDrive(DRIVE_SPEED,1.3,1.3,3);
            encoderDrive(DRIVE_SPEED, -1.4, 1.4, 3);
            encoderDrive(DRIVE_SPEED,-5.6,-5.6,10);
            encoderDrive(DRIVE_SPEED, -1.4, 1.4, 3);
